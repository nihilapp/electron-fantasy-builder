...
import { creatureTraitMapsTable as localTable } from '../common/db/schema/local/creature_trait_maps.table';
import { creatureTraitMapsTable as remoteTable } from '../common/db/schema/remote/creature_trait_maps.table';

/**
 * @description DB row → 종족-특성 매핑 VO.
 * @param row DB 결과 한 행
 */
