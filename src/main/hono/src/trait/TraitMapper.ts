...
import { traitsTable as localTraitsTable } from '../common/db/schema/local/traits.table';
import { traitsTable as remoteTraitsTable } from '../common/db/schema/remote/traits.table';
