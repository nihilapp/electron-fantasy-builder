...
import { coreRulesTable as localCoreRulesTable } from '../common/db/schema/local/core_rules.table';
import { coreRulesTable as remoteCoreRulesTable } from '../common/db/schema/remote/core_rules.table';
