...
import { eventsTable as localEventsTable } from '../common/db/schema/local/events.table';
import { eventsTable as remoteEventsTable } from '../common/db/schema/remote/events.table';
