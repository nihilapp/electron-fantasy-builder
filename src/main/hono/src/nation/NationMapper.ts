...
import { nationsTable as localNationsTable } from '../common/db/schema/local/nations.table';
import { nationsTable as remoteNationsTable } from '../common/db/schema/remote/nations.table';
