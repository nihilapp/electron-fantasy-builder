...
import { abilitiesTable as localAbilitiesTable } from '../common/db/schema/local/abilities.table';
import { abilitiesTable as remoteAbilitiesTable } from '../common/db/schema/remote/abilities.table';
