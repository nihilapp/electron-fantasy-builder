...
import { creaturesTable as localCreaturesTable } from '../common/db/schema/local/creatures.table';
import { creaturesTable as remoteCreaturesTable } from '../common/db/schema/remote/creatures.table';
