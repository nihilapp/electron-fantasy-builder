...
import { organizationsTable as localOrganizationsTable } from '../common/db/schema/local/organizations.table';
import { organizationsTable as remoteOrganizationsTable } from '../common/db/schema/remote/organizations.table';
