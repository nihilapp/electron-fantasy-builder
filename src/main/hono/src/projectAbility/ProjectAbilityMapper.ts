...
import { projectAbilitiesTable as localProjectAbilitiesTable } from '../common/db/schema/local/project_abilities.table';
import { projectAbilitiesTable as remoteProjectAbilitiesTable } from '../common/db/schema/remote/project_abilities.table';
