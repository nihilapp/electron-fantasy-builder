...
import { projectsTable as localProjectsTable } from '../common/db/schema/local/projects.table';
import { projectsTable as remoteProjectsTable } from '../common/db/schema/remote/projects.table';
