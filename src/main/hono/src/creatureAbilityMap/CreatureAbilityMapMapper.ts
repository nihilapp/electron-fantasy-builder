...
import { creatureAbilityMapsTable as localTable } from '../common/db/schema/local/creature_ability_maps.table';
import { creatureAbilityMapsTable as remoteTable } from '../common/db/schema/remote/creature_ability_maps.table';
