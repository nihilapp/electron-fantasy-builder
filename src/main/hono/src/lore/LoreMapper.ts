...
import { loresTable as localLoresTable } from '../common/db/schema/local/lores.table';
import { loresTable as remoteLoresTable } from '../common/db/schema/remote/lores.table';
