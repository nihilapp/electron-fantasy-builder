...
import { charactersTable as localCharactersTable } from '../common/db/schema/local/characters.table';
import { charactersTable as remoteCharactersTable } from '../common/db/schema/remote/characters.table';
