...
/**
 * useMutation 래퍼 (PATCH). mutationFn, 성공 시 무효화할 queryKey 배열(또는 함수)을 객체로 받음.
 */

export interface UsePatchOptions<TData, TVariables> {
...
/**
 * @description PATCH 계열 API를 useMutation으로 감싸고, onSuccess 시 invalidateKeys로 캐시 무효화.
 */
