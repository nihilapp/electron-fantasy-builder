...
CREATE TABLE public.core_rules (
    ...
    tags text NULL,
    lore_type text DEFAULT 'CORE_RULE'::text NULL,
    sub_lore_type text NULL,
    crt_no int8 NULL,
    crt_dt timestamp DEFAULT CURRENT_TIMESTAMP NULL,
    updt_no int8 NULL,
    updt_dt timestamp DEFAULT CURRENT_TIMESTAMP NULL,
...
CREATE TABLE public.creatures (
    ...
    del_yn varchar DEFAULT 'N'::character varying NULL,
    tags text NULL,
    lore_type text DEFAULT 'CREATURE'::text NULL,
    sub_lore_type text NULL,
    crt_no int8 NULL,
    crt_dt timestamp DEFAULT CURRENT_TIMESTAMP NULL,
    updt_no int8 NULL,
...
CREATE TABLE public.events (
    ...
    del_yn varchar DEFAULT 'N'::character varying NULL,
    tags text NULL,
    lore_type text DEFAULT 'EVENT'::text NULL,
    sub_lore_type text NULL,
    crt_no int8 NULL,
    crt_dt timestamp DEFAULT CURRENT_TIMESTAMP NULL,
    updt_no int8 NULL,
...
CREATE TABLE public.items (
    ...
    del_yn varchar DEFAULT 'N'::character varying NULL,
    tags text NULL,
    lore_type text DEFAULT 'ITEM'::text NULL,
    sub_lore_type text NULL,
    crt_no int8 NULL,
    crt_dt timestamp DEFAULT CURRENT_TIMESTAMP NULL,
    updt_no int8 NULL,
...
CREATE TABLE public.lores (
    ...
    lore_type text DEFAULT 'LORE'::text NULL,
...
CREATE TABLE public.nations (
    ...
    del_yn varchar DEFAULT 'N'::character varying NULL,
    tags text NULL,
    lore_type text DEFAULT 'NATION'::text NULL,
    sub_lore_type text NULL,
    crt_no int8 NULL,
    crt_dt timestamp DEFAULT CURRENT_TIMESTAMP NULL,
    updt_no int8 NULL,
...
CREATE TABLE public.organizations (
    ...
    del_yn varchar DEFAULT 'N'::character varying NULL,
    tags text NULL,
    lore_type text DEFAULT 'ORGANIZATION'::text NULL,
    sub_lore_type text NULL,
    crt_no int8 NULL,
    crt_dt timestamp DEFAULT CURRENT_TIMESTAMP NULL,
    updt_no int8 NULL,
...
CREATE TABLE public.setting_protections (
    ...
    CONSTRAINT setting_protections_prj_category_no_unique UNIQUE (
        prj_no,
        setting_category,
        setting_no
    ),
...
CREATE TABLE public.setting_favorites (
    ...
    CONSTRAINT setting_favorites_prj_category_no_unique UNIQUE (
        prj_no,
        setting_category,
        setting_no
    ),
...
CREATE TABLE public.regions (
    ...
    del_yn varchar DEFAULT 'N'::character varying NULL,
    tags text NULL,
    lore_type text DEFAULT 'REGION'::text NULL,
    sub_lore_type text NULL,
    crt_no int8 NULL,
    crt_dt timestamp DEFAULT CURRENT_TIMESTAMP NULL,
    updt_no int8 NULL,
...
CREATE TABLE public."characters" (
    ...
    del_yn varchar DEFAULT 'N'::character varying NULL,
    tags text NULL,
    lore_type text DEFAULT 'CHARACTER'::text NULL,
    sub_lore_type text NULL,
    crt_no int8 NULL,
    crt_dt timestamp DEFAULT CURRENT_TIMESTAMP NULL,
    updt_no int8 NULL,
...
WITH
GRANT OPTION;-- public.char_ability_maps definition

CREATE TABLE public.char_ability_maps (
    char_no int4 NOT NULL,
    ability_no int4 NOT NULL,
    ability_type varchar(20) NOT NULL,
    prof_lvl int4 NULL,
    ability_rmk text NULL,
    CONSTRAINT char_ability_maps_pkey PRIMARY KEY (char_no, ability_no, ability_type),
    CONSTRAINT char_ability_maps_char_no_fkey FOREIGN KEY (char_no) REFERENCES public."characters" (char_no)
);

CREATE INDEX ix_char_ability_maps_char_no ON public.char_ability_maps USING btree (char_no);

-- Permissions

ALTER TABLE public.char_ability_maps OWNER TO neondb_owner;

GRANT ALL ON TABLE public.char_ability_maps TO neondb_owner;

-- public.creature_ability_maps definition

CREATE TABLE public.creature_ability_maps (
    map_no serial4 NOT NULL,
    creature_no int4 NOT NULL,
    ability_no int4 NOT NULL,
    ability_type varchar(20) NOT NULL,
    prof_lvl int4 NULL,
    ability_rmk text NULL,
    CONSTRAINT creature_ability_maps_pkey PRIMARY KEY (map_no),
    CONSTRAINT creature_ability_maps_creature_no_fkey FOREIGN KEY (creature_no) REFERENCES public.creatures (creature_no)
);

CREATE INDEX ix_creature_ability_maps_creature_no ON public.creature_ability_maps USING btree (creature_no);

-- Permissions

ALTER TABLE public.creature_ability_maps OWNER TO neondb_owner;

GRANT ALL ON TABLE public.creature_ability_maps TO neondb_owner;

-- public.item_ability_maps definition

CREATE TABLE public.item_ability_maps (
    map_no serial4 NOT NULL,
    item_no int4 NOT NULL,
    ability_no int4 NOT NULL,
    ability_type varchar(20) NOT NULL,
    prof_lvl int4 NULL,
    ability_rmk text NULL,
    CONSTRAINT item_ability_maps_pkey PRIMARY KEY (map_no),
    CONSTRAINT item_ability_maps_item_no_fkey FOREIGN KEY (item_no) REFERENCES public.items (item_no)
);

CREATE INDEX ix_item_ability_maps_item_no ON public.item_ability_maps USING btree (item_no);

-- Permissions

ALTER TABLE public.item_ability_maps OWNER TO neondb_owner;

GRANT ALL ON TABLE public.item_ability_maps TO neondb_owner;